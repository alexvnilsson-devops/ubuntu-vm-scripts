...
echo $STARTUP_INSTANCE_ROOT
echo $STARTUP_INSTANCE_SCRIPTS_ROOT
...
if [[ ! -f "$STARTUP_INSTANCE_ROOT/$STARTUP_INSTANCE_FILENAME" ]]; then
    ...
    STARTUP_INSTANCE_CONTENT=`cat $STARTUP_INSTANCE_ROOT/$STARTUP_INSTANCE_FILENAME`
    echo -e "\e[32mInitializing VM-instance \e[39m\e[1m$STARTUP_INSTANCE_CONTENT\e[0m..."
fi
